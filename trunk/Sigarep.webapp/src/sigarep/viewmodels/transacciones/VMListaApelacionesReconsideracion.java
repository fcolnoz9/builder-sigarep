...
public class VMListaApelacionesReconsideracion  {
	...
	@WireVariable ServicioSolicitudApelacion serviciosolicitudapelacion;
	...
	@Init
		...
		public void buscarSancionados(){ 
	  		listaSancionados = serviciosolicitudapelacion.buscarSancionadosReconsideracion();
		}

	  
	  	@Command
		@NotifyChange({ "solicitudapelacionseleccionada" })
		public void MostrarSancionados () {
		
				final HashMap<String, Object> map = new HashMap<String, Object>();
		        map.put("solicitudapelacionseleccionada", this.solicitudapelacionseleccionada);
