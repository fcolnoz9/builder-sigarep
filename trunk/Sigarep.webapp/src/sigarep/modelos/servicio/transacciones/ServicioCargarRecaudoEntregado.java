...
//Servicio en el que se deben declarar las querys que se relacionan a la lista de estudiantes
//que realizaron una apelacion y le han sido verificado sus recaudos, ademas de la 
//visualizacion de los recaudos verificados de un estudiante para la carga y descarga

@Service("serviciocargarrecaudoentregado")
public class ServicioCargarRecaudoEntregado {
	
	@PersistenceContext
	private EntityManager em;

	public ServicioCargarRecaudoEntregado() {
		// TODO Auto-generated constructor stub
	}

	
	public List<ListaCargarRecaudoEntregado> buscarApelaciones() {
		String tiraSql =
	...
	public List<ListaCargarRecaudoEntregado> buscarPorFiltros(ListaCargarRecaudoEntregadoFiltros filtros){
        ...
        if(programa==null || motivo==null || cedula==null 
			...
			for (ListaCargarRecaudoEntregado ap : buscarApelaciones())
			{
