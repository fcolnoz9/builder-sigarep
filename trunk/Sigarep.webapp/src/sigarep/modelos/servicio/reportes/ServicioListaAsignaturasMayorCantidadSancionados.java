...
public class ServicioListaAsignaturasMayorCantidadSancionados {
	...
	public List<ListaAsignaturasMayorCantidadSancionados> buscarAsignaturasSancionados(Integer idPrograma,String codigoLapsoI, String codigoLapsoF){
		String queryStatement2= "SELECT * from (SELECT b.nombre_asignatura, b.cantidadSancionados,"
				+ "b.lapso, rank()  OVER (PARTITION BY b.lapso ORDER BY b.cantidadSancionados DESC)" 
				...
				+ "aes.codigo_asignatura= a.codigo_asignatura and aes.codigo_lapso between ? and ? "
		...
		query.setParameter(2,codigoLapsoI);
