...
/**
* Clase Servicio ServicioReporteConfigurableApelaciones busca
...
public class ServicioReporteConfigurableApelaciones {
	 ...
	 */
	public List<ConfigurableApelaciones> buscarTodasApelaciones(String lapsoAcademico,String tiposancion,String instanciaApelada,String tipoMotivo, String programaAcademico,String veredicto,String edoApelacion,String asignatura) {
		...
		"and es.id_programa="+""+programaAcademico+"  and sap.veredicto="+""+veredicto+" and sap.codigo_lapso="+""+lapsoAcademico+" "+""+tiraSql+" order by prog.nombre_programa";
